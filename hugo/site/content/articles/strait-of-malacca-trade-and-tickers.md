...
For investors, the strait is invisible infrastructure. You don't think about it when you check oil prices, review a tanker company's earnings, or wonder why shipping rates spiked. But roughly **one in four dollars of global maritime trade** passes through this 800-kilometer channel. If it closed for a week, the estimated rerouting cost alone would exceed $85 million — and the cascading disruptions to energy, manufacturing, and retail supply chains would be orders of magnitude larger.

This article maps the strait to the stock market. We'll trace the flow of goods — oil, gas, containers, bulk commodities — through the Strait of Malacca and connect each category to the **53 US-listed companies** whose businesses depend on it. Every ticker links to its page on this site, where you can explore strategy scores, key metrics, and daily data.
...
| **Width** | 65 km at widest → 2.8 km at narrowest |
| **Depth** | As shallow as 25 m in the south |
...
| Ticker | Company | Role |
|---|---|---|
| [XOM](/tickers/xom/) | Exxon Mobil | World's largest publicly traded oil company; major Asian export volumes |
| [CVX](/tickers/cvx/) | Chevron | Significant Southeast Asian operations including offshore Malaysia |
| [BP](/tickers/bp/) | BP plc | Global crude flows; major LNG trading desk |
| [TTE](/tickers/tte/) | TotalEnergies | Large LNG portfolio; Asian refining partnerships |
| [EQNR](/tickers/eqnr/) | Equinor | Norwegian state oil company; growing Asian LNG presence |
| [COP](/tickers/cop/) | ConocoPhillips | Major E&P with Asia-Pacific crude flows |
| [OXY](/tickers/oxy/) | Occidental Petroleum | Permian Basin production with export exposure |

For an investor, these companies are affected by Malacca Strait risk in a specific way: any disruption that reroutes tankers through the longer **Lombok Strait** or **Sunda Strait** adds days to transit time and dollars to shipping costs — which shows up in crude price spreads between Brent and Asian benchmarks.

---

## The Tanker Fleet: Who Carries the Oil?

If the oil majors produce what flows through the strait, tanker companies are the ones who physically move it. This is the single largest category of Malacca-related tickers in our database — **20 companies** — reflecting the sheer scale of energy shipments.

### Crude oil tankers

| Ticker | Company | Fleet focus |
|---|---|---|
| [FRO](/tickers/fro/) | Frontline | VLCCs and Suezmax tankers; one of the world's largest tanker operators |
| [DHT](/tickers/dht/) | DHT Holdings | Pure-play VLCC fleet |
| [INSW](/tickers/insw/) | International Seaways | VLCCs, Suezmaxes, and Aframaxes |
| [NAT](/tickers/nat/) | Nordic American Tankers | Suezmax specialist |
| [STNG](/tickers/stng/) | Scorpio Tankers | Product tankers (refined fuels) |
| [TRMD](/tickers/trmd/) | TORM plc | Product and crude tankers |
| [TNK](/tickers/tnk/) | Teekay Tankers | Suezmaxes and Aframaxes |
| [TK](/tickers/tk/) | Teekay Corporation | Tanker parent company; also LNG/LPG |
| [TEN](/tickers/ten/) | Tsakos Energy Navigation | Diversified tanker fleet |
| [ECO](/tickers/eco/) | Okeanis Eco Tankers | Modern eco-design VLCCs and Suezmaxes |
| [HAFN](/tickers/hafn/) | Hafnia Limited | Product tankers — refined fuels and chemicals |

**A quick primer on tanker types:** VLCCs (Very Large Crude Carriers) hold 2 million barrels but draw too deep for the shallowest parts of the strait. Suezmaxes (~1 million barrels) and Aframaxes (~750,000 barrels) navigate more easily. Product tankers carry refined fuels — gasoline, diesel, jet fuel — in smaller parcels. The mix of tanker sizes transiting the strait reflects its physical depth constraints.

### LNG and gas carriers

Liquefied natural gas is the strait's second-largest energy cargo. As Asian economies transition away from coal, LNG demand has surged — and most of it passes through Malacca.

| Ticker | Company | Focus |
|---|---|---|
| [LNG](/tickers/lng/) | Cheniere Energy | Largest US LNG exporter; major Asian supply contracts |
| [GLNG](/tickers/glng/) | Golar LNG | LNG carriers and floating liquefaction |
| [FLNG](/tickers/flng/) | FLEX LNG | Modern LNG carrier fleet |
| [LPG](/tickers/lpg/) | Dorian LPG | Very Large Gas Carriers (VLGCs) |
| [BWLP](/tickers/bwlp/) | BW LPG | World's largest LPG shipper |
| [GASS](/tickers/gass/) | StealthGas | Small LPG carriers; regional routes |
| [EE](/tickers/ee/) | Excelerate Energy | Floating LNG import terminals |

### Other maritime and offshore

| Ticker | Company | Connection |
|---|---|---|
| [SFL](/tickers/sfl/) | SFL Corporation | Ship leasing — tankers, containers, dry bulk |
| [HSHP](/tickers/hshp/) | Himalaya Shipping | Newcastlemax dry bulk carriers |
| [SHIP](/tickers/ship/) | Seanergy Maritime | Capesize dry bulk fleet |
| [ESEA](/tickers/esea/) | Euroseas | Containerships and multipurpose |
| [SVRN](/tickers/svrn/) | OceanPal | Dry bulk shipping |
| [SMHI](/tickers/smhi/) | SEACOR Marine | Offshore support vessels |
| [KEX](/tickers/kex/) | Kirby Corporation | Marine transportation (inland + coastal) |
...
Beyond energy, the strait is the highway for **containerized cargo** — the physical supply chain behind every electronic device, article of clothing, and household good traded between Asia and the rest of the world. Container ships carry everything from iPhones to IKEA furniture.

| Ticker | Company | Role |
|---|---|---|
| [ZIM](/tickers/zim/) | ZIM Integrated Shipping | Israeli container line; major Asia-Europe and transpacific routes |
...
The world's largest container shipping companies — **Maersk** (Denmark), **COSCO** (China), **Evergreen** and **Yang Ming** (Taiwan) — are not listed on US exchanges and therefore aren't in our database. Together, they control the majority of container capacity transiting the strait. If you're investing in container shipping, these are the names that dominate the Malacca route even though we can't provide ticker pages for them.

---

## Dry Bulk: Iron Ore, Coal, and Grains

Bulk carriers move the raw materials of industrial economies — iron ore for Chinese steel mills, coal for power generation, grain for food supply. Bulk carrier transits through the strait hit a **record 19,507 vessels in 2024**.

| Ticker | Company | Cargo focus |
|---|---|---|
| [SBLK](/tickers/sblk/) | Star Bulk Carriers | Largest US-listed dry bulk fleet; iron ore, coal, grain |
| [GNK](/tickers/gnk/) | Genco Shipping | Capesize and ultramax dry bulk |
| [PANL](/tickers/panl/) | Pangaea Logistics | Specialized dry bulk and project cargo |
| [SB](/tickers/sb/) | Safe Bulkers | Panamax and Kamsarmax dry bulk carriers |
...
| Ticker | Company | Connection to strait |
|---|---|---|
| [MPC](/tickers/mpc/) | Marathon Petroleum | Largest US refiner; global crude sourcing |
| [PSX](/tickers/psx/) | Phillips 66 | Refining + midstream; exposed to global crude flows |
| [VLO](/tickers/vlo/) | Valero Energy | Largest independent refiner; imports crude globally |
| [PBF](/tickers/pbf/) | PBF Energy | East Coast refiner; sensitive to shipping-driven crude spreads |
| [DK](/tickers/dk/) | Delek US Holdings | Regional refiner with import exposure |
...
| Ticker | Company | Strait connection |
|---|---|---|
| [RTX](/tickers/rtx/) | RTX Corporation (Raytheon) | Naval defense systems; maritime surveillance radar |
| [LMT](/tickers/lmt/) | Lockheed Martin | Combat ships; P-8 maritime patrol aircraft |
| [NOC](/tickers/noc/) | Northrop Grumman | Autonomous maritime systems; ISR platforms |
| [BA](/tickers/ba/) | Boeing | P-8A Poseidon maritime patrol; defense contracts |
...
Singapore sits at the eastern mouth of the Strait of Malacca. It's not just adjacent to the strait — it **is** the strait's economic engine.
...
For Singaporean investors, the companies in this article are the American-listed counterparts to the maritime ecosystem you see daily in your harbor. The tankers anchored off Jurong Island, the container ships at Pasir Panjang — these belong to companies like [FRO](/tickers/fro/), [ZIM](/tickers/zim/), and [STNG](/tickers/stng/).

### The Singapore tickers we wish we could link
...
|---|---|---|
| [GRAB](/tickers/grab/) | Grab Holdings | Singapore's super-app; listed on Nasdaq. Not a maritime company, but the largest Singapore-headquartered stock in our database. If you're a Singaporean investor exploring US markets, [our detailed GRAB analysis](/articles/southeast-asia-unicorn-tickerengine-grab/) is worth reading. |
...
**China's response — the Belt and Road Initiative:** To reduce Malacca dependency, China has invested in overland alternatives: pipelines from Central Asia (operational since 2006), the China-Pakistan Economic Corridor with port access at Gwadar, and the Myanmar-China oil and gas pipelines. None fully replace the strait's capacity, but they hedge against disruption.

For investors, the disruption scenario is a **tail risk** that disproportionately affects tanker and container shipping stocks. Companies with diverse route portfolios (like [MATX](/tickers/matx/) with its Pacific focus, or [INSW](/tickers/insw/) with multi-basin operations) may be more resilient than those concentrated on the Middle East → East Asia run.
...
| Ticker | Company |
|---|---|
| [XOM](/tickers/xom/) | Exxon Mobil Corporation |
| [CVX](/tickers/cvx/) | Chevron Corporation |
| [BP](/tickers/bp/) | BP plc |
| [TTE](/tickers/tte/) | TotalEnergies SE |
| [EQNR](/tickers/eqnr/) | Equinor ASA |
| [COP](/tickers/cop/) | ConocoPhillips |
| [OXY](/tickers/oxy/) | Occidental Petroleum |

### Crude Oil Tankers (11)

| Ticker | Company |
|---|---|
| [FRO](/tickers/fro/) | Frontline Plc |
| [DHT](/tickers/dht/) | DHT Holdings |
| [INSW](/tickers/insw/) | International Seaways |
| [NAT](/tickers/nat/) | Nordic American Tankers |
| [STNG](/tickers/stng/) | Scorpio Tankers |
| [TRMD](/tickers/trmd/) | TORM plc |
| [TNK](/tickers/tnk/) | Teekay Tankers |
| [TK](/tickers/tk/) | Teekay Corporation |
| [TEN](/tickers/ten/) | Tsakos Energy Navigation |
| [ECO](/tickers/eco/) | Okeanis Eco Tankers |
| [HAFN](/tickers/hafn/) | Hafnia Limited |

### LNG & Gas Carriers (7)

| Ticker | Company |
|---|---|
| [LNG](/tickers/lng/) | Cheniere Energy |
| [GLNG](/tickers/glng/) | Golar LNG |
| [FLNG](/tickers/flng/) | FLEX LNG |
| [LPG](/tickers/lpg/) | Dorian LPG |
| [BWLP](/tickers/bwlp/) | BW LPG |
| [GASS](/tickers/gass/) | StealthGas |
| [EE](/tickers/ee/) | Excelerate Energy |

### Container Shipping (6)

| Ticker | Company |
|---|---|
| [ZIM](/tickers/zim/) | ZIM Integrated Shipping |
| [DAC](/tickers/dac/) | Danaos Corporation |
| [GSL](/tickers/gsl/) | Global Ship Lease |
| [CMRE](/tickers/cmre/) | Costamare |
| [ASC](/tickers/asc/) | Ardmore Shipping |
| [MATX](/tickers/matx/) | Matson |

### Dry Bulk Carriers (4)

| Ticker | Company |
|---|---|
| [SBLK](/tickers/sblk/) | Star Bulk Carriers |
| [GNK](/tickers/gnk/) | Genco Shipping |
| [PANL](/tickers/panl/) | Pangaea Logistics |
| [SB](/tickers/sb/) | Safe Bulkers |

### Other Maritime (7)

| Ticker | Company |
|---|---|
| [SFL](/tickers/sfl/) | SFL Corporation (ship leasing) |
| [HSHP](/tickers/hshp/) | Himalaya Shipping |
| [SHIP](/tickers/ship/) | Seanergy Maritime |
| [ESEA](/tickers/esea/) | Euroseas |
| [SVRN](/tickers/svrn/) | OceanPal |
| [SMHI](/tickers/smhi/) | SEACOR Marine |
| [KEX](/tickers/kex/) | Kirby Corporation |

### Oil Refiners (5)

| Ticker | Company |
|---|---|
| [MPC](/tickers/mpc/) | Marathon Petroleum |
| [PSX](/tickers/psx/) | Phillips 66 |
| [VLO](/tickers/vlo/) | Valero Energy |
| [PBF](/tickers/pbf/) | PBF Energy |
| [DK](/tickers/dk/) | Delek US Holdings |

### Defense & Security (4)

| Ticker | Company |
|---|---|
| [RTX](/tickers/rtx/) | RTX Corporation |
| [LMT](/tickers/lmt/) | Lockheed Martin |
| [NOC](/tickers/noc/) | Northrop Grumman |
| [BA](/tickers/ba/) | Boeing |

### Singapore Hub (1)

| Ticker | Company |
|---|---|
| [GRAB](/tickers/grab/) | Grab Holdings |

### Other (1)

| Ticker | Company |
|---|---|
| [ALB](/tickers/alb/) | Albemarle Corporation (lithium, chemicals) |
...
- **Singapore Exchange (SGX) tickers**: DBS, OCBC, UOB, Keppel, Sembcorp, SIA, Wilmar — the core maritime finance and infrastructure companies
