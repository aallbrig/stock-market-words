...
const EXCHANGE_DATA_PAGE_BASE = process.env.EXCHANGE_DATA_PAGE_BASE || "http://localhost:8668/exchange-data-display.html";
...
describe("The exchange data display page for English Dictionary Stocks website", () => {
  ...
  it("Should have a 🔥 page title", async () => {
    ...
    await page.goto(EXCHANGE_DATA_PAGE_BASE);
